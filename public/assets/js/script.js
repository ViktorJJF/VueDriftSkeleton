...
(function($) {
  ...
  $('ul.dt-side-nav > li.dt-side-nav__item').on('click', function() {
    var menuLi = this;
    $('ul.dt-side-nav > li.dt-side-nav__item')
      .not(menuLi)
      .removeClass('open');
    $('ul.dt-side-nav > li.dt-side-nav__item ul')
      .not($('ul', menuLi))
  ...
  $('ul.dt-side-nav__sub-menu li').on('click', function(e) {
    ...
    if ($current_sm_li_parent.parent().hasClass('active')) {
      ...
      $('ul.dt-side-nav__sub-menu li ul')
        .not($(' ul', $current_sm_li))
        .slideUp(slideDuration, function() {
